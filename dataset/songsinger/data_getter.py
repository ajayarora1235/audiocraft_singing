...
#s3_client.download_file(bucket_name, 'musicgen_datasets/piano_dataset_500.zip', 'full_dataset.zip')
s3_client.download_file(bucket_name, 'musicgen_datasets/data_piano_train.jsonl', 'train.jsonl')
s3_client.download_file(bucket_name, 'musicgen_datasets/data_piano_valid.jsonl', 'valid.jsonl')
s3_client.download_file(bucket_name, 'musicgen_datasets/data_piano_test.jsonl', 'test.jsonl')
